...
public class Service {
    ...
    public void addOrder(Connection connection){
        try {
            ...
            int row=preparedStatement.executeUpdate();
            if(row>0){
                String sql1="update m_shpp set time=? where  1 ORDER BY id DESC LIMIT 1";
                PreparedStatement preparedStatement1=connection.prepareStatement(sql1);
    ...
    public void updatePrice(Connection connection,String name){
        try {
            ...
            double price=scanner.nextDouble();
            String sql1="update m_shmp set buyPrice =? where m_shpp.buyName =?";
            PreparedStatement preparedStatement1=connection.prepareStatement(sql1);
    ...
    public void updateNumber(Connection connection,String name){
        try {
            ...
            String sql1="update m_shmp set number =? where m_shpp.buyName =?";
            PreparedStatement preparedStatement1=connection.prepareStatement(sql1);
